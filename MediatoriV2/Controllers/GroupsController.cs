...
namespace mediatori.Controllers
{
    ...
    public class GroupsController : MyBaseController
    {
        ...
        {
            MyWebApplication.Areas.Admin.Models.MyGroupModel model = new MyWebApplication.Areas.Admin.Models.MyGroupModel();
        ...
        public ActionResult Create(MyWebApplication.Areas.Admin.Models.MyGroupModel model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(MyWebApplication.Areas.Admin.Models.MyGroupModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    if (!String.IsNullOrEmpty(Request["myItems"]))
                    {
                        foreach (string s in Request["myItems"].Split(','))
                        {
                            manager.addUser(model.Gruppo.gruppoId, long.Parse(s));
                        }
                    }
                }
                finally
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Roles(MyWebApplication.Areas.Admin.Models.MyGroupModel model)
        {
