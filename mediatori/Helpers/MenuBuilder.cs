        ...
        private static void initMenu()
        {
            ...
            configMenu.Add(EMenuSection.ANAGRAFICA,
                new List<MenuElement>(){
                    ...
                    new MenuElement(){display="Amministratore", ordinamento=5,livello=1,url="/Amministratore"},
                    new MenuElement(){display="Nuova Amministratore", ordinamento=6,livello=2,url="/Amministratore/Create"},
            ...
            configMenu.Add(EMenuSection.CONFIGURAZIONI,
              new List<MenuElement>(){
                    ...
                    new MenuElement(){display="Tipo Inrizzo", ordinamento=1,livello=1,role="Amministratore",url="/Configurazioni/tipologiaIndirizzo"},
